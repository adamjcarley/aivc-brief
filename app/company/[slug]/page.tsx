  ...
  return (
    <div className="min-h-screen bg-[var(--bg)]">
      ...
      <div className="max-w-[960px] mx-auto px-8 py-6">
        ...
        {hasBrief && <BriefContent brief={briefContent} company={company} />}
      </div>
    </div>
  );
}

function BriefContent({ brief, company }: { brief: Record<string, unknown>; company: Record<string, string | number | string[] | null> }) {
